// Package d2app contains the Nostos application shell
package d2app
...
func Create(gitBranch, gitCommit string) *App {
	...
	app.Infof("Nostos - Open source Diablo 2 engine")
...
func (a *App) loadEngine() error {
	...
	if a.errorMessage != nil {
		return a.renderer.Run(a.updateInitError, updateNOOP, 800, 600, "Nostos")
	}
...
func (a *App) parseArguments() {
	...
	if *showVersion {
		a.Infof("version: Nostos (%s %s)", a.gitBranch, a.gitCommit)
		os.Exit(0)
	}
...
// LoadConfig loads the Nostos config file
...
func (a *App) Run() (err error) {
	...
	windowTitle := fmt.Sprintf("Nostos (%s)", a.gitBranch)
